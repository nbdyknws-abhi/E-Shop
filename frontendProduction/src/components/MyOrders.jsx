...
const MyOrders = ({ embedded = false }) => {
    ...
    const fetchOrders = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          console.log("Fetched orders for user:", userId, data);
  ...
  if (loading) {
    return (
      <div
        className={`${
          !embedded ? "min-h-screen bg-gray-50" : ""
        } flex justify-center items-center ${embedded ? "py-8" : ""}`}
      >
  ...
  // Embedded component (for profile page)
  return (
    <div className="p-6">
...
// Separate component for orders content to avoid duplication
const OrdersContent = ({
  orders,
  normalizeOrder,
  getStatusColor,
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Placed on {formatDate(order.createdAt || order.createAt)}
                  </p>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                    ...
                    {order.items && order.items.length > 0 ? (
                      ...
                      <div className="p-3 bg-gray-50 rounded-lg text-center text-gray-500">
                        ...
                        <p className="text-xs mt-1">
                          This order was placed before the detailed tracking
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg text-sm">
                      <p>Payment Method: {order.paymentMethod || "Razorpay"}</p>
